...
def init_colors(theme: str = 'default') -> None:
    ...
    W = curses.COLOR_WHITE;  BL = curses.COLOR_BLUE;  CY = curses.COLOR_CYAN
    BK = curses.COLOR_BLACK; R  = curses.COLOR_RED;   G  = curses.COLOR_GREEN
    Y  = curses.COLOR_YELLOW

    palettes = {
        'default': [
            (HEADER,        W,  BL), (MENU_NORMAL,   -1, -1),
            (MENU_SELECTED, BK, CY), (BORDER,        BL, -1),
            (WARNING,       R,  -1), (ERROR,         W,  R),
            (SUCCESS,       G,  -1), (DIM,           BK, -1), (TITLE, W, -1),
        ],
        'dark': [
            (HEADER,        G,  BK), (MENU_NORMAL,   -1, -1),
            (MENU_SELECTED, BK, G),  (BORDER,        G,  -1),
            (WARNING,       Y,  -1), (ERROR,         W,  R),
            (SUCCESS,       G,  -1), (DIM,           BK, -1), (TITLE, G, -1),
        ],
        'high_contrast': [
            # All pairs use terminal defaults; pair() injects A_REVERSE
            # for HEADER, MENU_SELECTED, ERROR via _HIGH_CONTRAST_REVERSE.
            (HEADER, -1, -1), (MENU_NORMAL, -1, -1), (MENU_SELECTED, -1, -1),
            (BORDER, -1, -1), (WARNING,     -1, -1), (ERROR,         -1, -1),
            (SUCCESS,-1, -1), (DIM,         -1, -1), (TITLE,         -1, -1),
        ],
    }
