...
from truenas_tui.plugins.my_account.view import MyAccountPlugin, _extract_secret, _find_qr_tool
...
class TestOnetimePasswordPlugin:
    def test_calls_generate_with_session_username(self, recording_session, stdscr):
        ...
        (args, _) = recording_session.called_with(Method.AUTH_GENERATE_ONETIME_PASSWORD)[0]
    ...
    def test_error_from_api_shows_dialog(self, recording_session, stdscr):
        recording_session.override(Method.AUTH_GENERATE_ONETIME_PASSWORD,
...
# ===========================================================================
# PasswordPlugin – _change_password path (has_admin = True)
# ===========================================================================
...
class TestPasswordPluginChangePassword:
    ...
    def test_successful_password_change_calls_user_update(self, recording_session, stdscr):
        with patch(f'{_PW}.select_dialog', return_value=0), \
...
# ===========================================================================
# PasswordPlugin – _setup_administrator path (has_admin = False)
# ===========================================================================
...
class TestPasswordPluginSetupAdministrator:
    ...
    def test_setup_uses_root_username_for_index_1(self, stdscr):
        session = self._no_admin_session()
        with patch(f'{_PW}.select_dialog', return_value=1), \
             patch(f'{_PW}.input_dialog', side_effect=['newpassword', 'newpassword']), \
             patch(f'{_PW}.message_dialog'):
            PasswordPlugin().run(stdscr, session)
...
# ===========================================================================
# MyAccountPlugin – 2FA management
# ===========================================================================
...
class TestMyAccountPlugin2FA:
    ...
    # ------------------------------------------------------------------
    # _setup_2fa / USER_RENEW_2FA_SECRET
    # ------------------------------------------------------------------
    ...
    def test_setup_2fa_calls_renew(self, recording_session, stdscr):
        ...
        with patch(f'{_MA}._find_qr_tool', return_value='/usr/bin/qr'), \
    ...
    # ------------------------------------------------------------------
    # _disable_2fa / USER_UNSET_2FA_SECRET
    # ------------------------------------------------------------------
    ...
    def test_disable_2fa_calls_unset(self, recording_session, stdscr):
        ...
        recording_session.override(Method.AUTH_ME, {
    ...
    def test_disabled_action_shows_dialog_not_api(self, recording_session, stdscr):
        ...
        with patch(f'{_MA}._find_qr_tool', return_value=None), \
